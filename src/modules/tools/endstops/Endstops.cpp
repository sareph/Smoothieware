...
void Endstops::home(axis_bitmap_t a)
{
    ...
    if (false == THEKERNEL->robot->homing_done[X_AXIS] && (a[X_AXIS])) {
        THEKERNEL->robot->homing_done[X_AXIS] = true;
    }
    if (false == THEKERNEL->robot->homing_done[Y_AXIS] && (a[Y_AXIS])) {
        THEKERNEL->robot->homing_done[Y_AXIS] = true;
    }
    if (false == THEKERNEL->robot->homing_done[Z_AXIS] && (a[Z_AXIS])) {
